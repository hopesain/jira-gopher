...
func GetProjects(credentials jira.Credentials) (ProjectsResponse, error) {
	client := &http.Client{
...
func CreateProject(credentials jira.Credentials, payload CreateProjectRequest) (CreateProjectResponse, error) {
